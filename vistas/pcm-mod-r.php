        ...
        <div class="container" style="padding: 0px 20px 50px 20px;">
            <div class="row justify-content-center">
                <?php if ($procesar=="ok") {  ?>
                    ...
                    <!-- Tarjeta de datos -->
                    <div class="col-md-10">
                        <form class="" action="pcm-mod-r.php" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="txtId" placeholder="Introduce ID del Operadro" value="<?php echo $txtId; ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="txtCant_total_horas_trab" step="1.00" min="0" placeholder="0.00" value="<?php echo $txtCant_total_horas_trab; ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="txtMonto_pago_hora">$ por Hora</label>
                                                    <input type="number" class="form-control" name="txtMonto_pago_hora" step="0.01" min="0" placeholder="0.00" value="<?php echo $txtMonto_pago_hora; ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="txtCant_porcentaje_trab">% Trabajado</label>
                                                    <input type="number" max="60" min="1" step="1.00" class="form-control" name="txtCant_porcentaje_trab" placeholder="1.00" value="<?php echo $txtCant_porcentaje_trab; ?>" readonly>
                                                </div>
                                            </div>
                                            <!-- 
                                            <div class="col-md-3">
                                                ...
                                                <div class="col-md-12"><p class="text-center"><strong>-</strong></p> </div>
                                                    <div class="col-md-4"><?php // echo "%-> ".$txtEmoji1; ?></div>
                                                    <div class="col-md-4"><?php // echo "$-> ".$txtEmoji2; ?></div>
                                                </div>
                                            </div>
                                                        -->
                                            <div class="col-md-1">
                                                    <div class="form-group">
                                                        <label for="txtEmoji1">% T</label>
                                                        <input type="text" class="form-control" name="txtEmoji1" value="<?php echo $txtEmoji1?>" readonly>
                                                    </div>
                                            </div>
                                            <div class="col-md-1">
                                                    <div class="form-group">
                                                        <label for="txtEmoji2">$ Hr</label>
                                                        <input type="text" class="form-control" name="txtEmoji2" value="<?php echo $txtEmoji2?>" readonly>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>  
